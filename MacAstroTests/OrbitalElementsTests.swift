...
class OrbitalElementsTests: XCTestCase {
    ...
    func testHelioOrbCoords() {
        ...
        XCTAssertEqualWithAccuracy(-0.6657481021889328, hoc.x, accuracy: accuracy)
        XCTAssertEqualWithAccuracy(-1.424723224035724, hoc.y, accuracy: accuracy)
        XCTAssertEqualWithAccuracy(1.5725955616988474, hoc.z, accuracy: accuracy)
    }
    ...
    func testHelioEclCoords() {
        ...
        XCTAssertEqualWithAccuracy(0.7180208300043192, hec.x, accuracy: accuracy)
        XCTAssertEqualWithAccuracy(-0.10607733560942739, hec.y, accuracy: accuracy)
        XCTAssertEqualWithAccuracy(-0.04290011049715045, hec.z, accuracy: accuracy)
    }
